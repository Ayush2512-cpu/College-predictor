...
public class CollegePopulatorAdvance {
    ...
    private static final String state[] =  {"Maharashtra", "New Delhi", "Uttar Pradesh", "West Bengal", "Tamil Nadu", "Uttarakhand", "Uttar Pradesh", "Odisha","Gujarat","Hyderabad","Jharkhand","Madhya Pradesh","Himachal Pradesh","Bihar","Punjab","Assam","Kerala","Andhra Pradesh","Jammu & Kashmir","Goa","Rajasthan"};
